...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-stone-800">Adicionar Nova Categoria</h1>
    ...
    <div class="bg-white shadow-2xl rounded-2xl p-8">
        <form action="{{ route('categorias.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nome" id="nome" class="shadow-sm appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-shadow duration-200" value="{{ old('nome') }}" placeholder="Ex: Bebidas Quentes" required>
            </div>
