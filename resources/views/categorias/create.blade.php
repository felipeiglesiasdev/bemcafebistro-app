...
<div class="container mx-auto">
    <h1 class="text-3xl font-bold text-amber-900 mb-6">Adicionar Nova Categoria</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('categorias.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nome" id="nome" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('nome') }}" placeholder="Ex: Bebidas Quentes" required>
            </div>
