...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-700">Produtos</h1>
        <a href="{{ route('produtos.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $produto->id }}</td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $produto->nome }}</td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $produto->categoria->nome ?? 'Sem categoria' }}</td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">{{ $produto->marca }}</td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('produtos.edit', $produto->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold p-2 rounded inline-flex items-center">
                            ...
                            <button type="button" class="bg-red-500 hover:bg-red-600 text-white font-bold p-2 rounded inline-flex items-center delete-btn" data-url="{{ route('produtos.destroy', $produto->id) }}">
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-5 py-5 border-b border-gray-200 bg-white text-sm text-center">Nenhum produto encontrado.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
